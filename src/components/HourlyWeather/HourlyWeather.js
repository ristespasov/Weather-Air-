    ...
    <div>
        <div className="hourly-item">
            <div className="hourly-detail">
                {
                    props.h_hour_1 &&
                    <p className="hour"><span>{moment(props.h_hour_1).format('HH:mm')}</span></p>
                }
                {
                    props.h_hour_1 &&
                    <p className="h-day"><span>{moment(props.h_hour_1).format('ddd')}</span></p>
                }
            </div>
            {
                props.h_icon_1 != null &&
                <div className="hourly-detail h-weather-icon-div">
            ...
            {
                props.h_temp_1 &&
                <p className="hourly-detail"><span className="h-temp">{Math.round(props.h_temp_1)} °C</span></p>
            }
            {
                props.h_realFeel_1 &&
        ...
        <div className="hourly-item">
            <div className="hourly-detail">
                {
                    props.h_hour_2 &&
                    <p className="hour"><span>{moment(props.h_hour_2).format('HH:mm')}</span></p>
                }
                {
                    props.h_hour_2 &&
                    <p className="h-day"><span>{moment(props.h_hour_2).format('ddd')}</span></p>
                }
            </div>
            {
                props.h_icon_2 != null &&
            ...
            {
                props.h_temp_2 &&
                <p className="hourly-detail"><span className="h-temp">{Math.round(props.h_temp_2)} °C</span></p>
            }
            {
                props.h_realFeel_2 &&
        ...
        <div className="hourly-item">
            <div className="hourly-detail">
                {
                    props.h_hour_3 &&
                    <p className="hour"><span>{moment(props.h_hour_3).format('HH:mm')}</span></p>
                }
                {
                    props.h_hour_3 &&
                    <p className="h-day"><span>{moment(props.h_hour_3).format('ddd')}</span></p>
                }
            </div>
            {
                props.h_icon_3 != null &&
            ...
            {
                props.h_temp_3 &&
                <p className="hourly-detail"><span className="h-temp">{Math.round(props.h_temp_3)} °C</span></p>
            }
            {
                props.h_realFeel_3 &&
        ...
        <div className="hourly-item">
            <div className="hourly-detail">
                {
                    props.h_hour_4 &&
                    <p className="hour"><span>{moment(props.h_hour_4).format('HH:mm')}</span></p>
                }
                {
                    props.h_hour_4 &&
                    <p className="h-day"><span>{moment(props.h_hour_4).format('ddd')}</span></p>
                }
            </div>
            {
                props.h_icon_4 != null &&
            ...
            {
                props.h_temp_4 &&
                <p className="hourly-detail"><span className="h-temp">{Math.round(props.h_temp_4)} °C</span></p>
            }
            {
                props.h_realFeel_4 &&
        ...
        <div className="hourly-item">
            <div className="hourly-detail">
                {
                    props.h_hour_5 &&
                    <p className="hour"><span>{moment(props.h_hour_5).format('HH:mm')}</span></p>
                }
                {
                    props.h_hour_5 &&
                    <p className="h-day"><span>{moment(props.h_hour_5).format('ddd')}</span></p>
                }
            </div>
            {
                props.h_icon_5 != null &&
            ...
            {
                props.h_temp_5 &&
                <p className="hourly-detail"><span className="h-temp">{Math.round(props.h_temp_5)} °C</span></p>
            }
            {
                props.h_realFeel_5 &&
        ...
        <div className="hourly-item">
            <div className="hourly-detail">
                {
                    props.h_hour_6 &&
                    <p className="hour"><span>{moment(props.h_hour_6).format('HH:mm')}</span></p>
                }
                {
                    props.h_hour_6 &&
                    <p className="h-day"><span>{moment(props.h_hour_6).format('ddd')}</span></p>
                }
            </div>
            {
                props.h_icon_6 != null &&
            ...
            {
                props.h_temp_6 &&
                <p className="hourly-detail"><span className="h-temp">{Math.round(props.h_temp_6)} °C</span></p>
            }
            {
                props.h_realFeel_6 &&
